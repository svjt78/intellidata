        ...
        if form.is_valid():
                    ...
                    with open('transmissions.csv', 'rt') as csv_file:
                        ...
                        for row in csv.reader(csv_file):
                                                      bad_ind = 0
                                                      transmissionid_bad_ind=0
                                                      SenderName_bad_ind=0
                                                      BenefitAdministratorPlatform_bad_ind=0
                                                      ReceiverName_bad_ind=0
                                                      TestProductionCode_bad_ind=0
                                                      TransmissionTypeCode_bad_ind=0
                                                      SystemVersionIdentifier_bad_ind=0
                                                    ...
                                                    #pass Transmission:
                                                      ...
                                                      if (Mandatory.objects.filter(attributes='transmission_transmissionid').exists()):
                                                          var=Mandatory.objects.filter(attributes='transmission_transmissionid')[0].required
                                                          if (var == "Yes" and transmissionid ==""):
                                                               array1=[]
                                                               bad_ind = 1
                                                               transmissionid_bad_ind = 1
                                                               description = "transmissionid is mandatory"
                                                      ...
                                                      if (Mandatory.objects.filter(attributes='transmission_SenderName').exists()):
                                                          ...
                                                          if (var == "Yes" and SenderName ==""):
                                                               array1=[]
                                                               bad_ind = 1
                                                               SenderName_bad_ind = 1
                                                      ...
                                                      if (Numcheck.objects.filter(attributes='transmission_SenderName').exists()):
                                                         ...
                                                         if (var == "Yes" and not SenderName.isdigit()):
                                                              array1=[]
                                                              bad_ind = 1
                                                              SenderName_bad_ind = 1
                                                      ...
                                                      if (Mandatory.objects.filter(attributes='transmission_BenefitAdministratorPlatform').exists()):
                                                          ...
                                                          if (var == "Yes" and BenefitAdministratorPlatform ==""):
                                                               array1=[]
                                                               bad_ind = 1
                                                               BenefitAdministratorPlatform_bad_ind = 1
                                                               description = "BenefitAdministratorPlatform is mandatory"
                                                               array1.append(serial)
                                                               array1.append(transmissionid)
                                                               array1.append(SenderName)
                                                               array1.append(BenefitAdministratorPlatform)
                                                               array1.append(description)
                                                               array_bad.append(array1)
                                                      ...
                                                      if (Numcheck.objects.filter(attributes='transmission_BenefitAdministratorPlatform').exists()):
                                                         ...
                                                         if (var == "Yes" and not BenefitAdministratorPlatform.isdigit()):
                                                              array1=[]
                                                              bad_ind = 1
                                                              BenefitAdministratorPlatform_bad_ind = 1
                                                      ...
                                                      if BenefitAdministratorPlatform_bad_ind == 0:
                                                      ...
                                                      if (Mandatory.objects.filter(attributes='transmission_ReceiverName').exists()):
                                                          ...
                                                          if (var == "Yes" and ReceiverName ==""):
                                                               array1=[]
                                                               bad_ind = 1
                                                               ReceiverName_bad_ind = 1
                                                               description = "ReceiverName is mandatory"
                                                               array1.append(serial)
                                                               array1.append(transmissionid)
                                                               array1.append(SenderName)
                                                               array1.append(ReceiverName)
                                                               array1.append(description)
                                                               array_bad.append(array1)
                                                      ...
                                                      if (Numcheck.objects.filter(attributes='transmission_ReceiverName').exists()):
                                                         ...
                                                         if (var == "Yes" and not ReceiverName.isdigit()):
                                                              array1=[]
                                                              bad_ind = 1
                                                              ReceiverName_bad_ind = 1
                                                      ...
                                                      if (Mandatory.objects.filter(attributes='transmission_TestProductionCode').exists()):
                                                          ...
                                                          if (var == "Yes" and TestProductionCode ==""):
                                                               array1=[]
                                                               bad_ind = 1
                                                               TestProductionCode_bad_ind = 1
                                                               description = "TestProductionCode is mandatory"
                                                               array1.append(serial)
                                                               array1.append(transmissionid)
                                                               array1.append(SenderName)
                                                               array1.append(TestProductionCode)
                                                               array1.append(description)
                                                               array_bad.append(array1)
                                                      ...
                                                      if (Numcheck.objects.filter(attributes='transmission_TestProductionCode').exists()):
                                                         ...
                                                         if (var == "Yes" and not TestProductionCode.isdigit()):
                                                              array1=[]
                                                              bad_ind = 1
                                                              TestProductionCode_bad_ind = 1
                                                      ...
                                                      if TestProductionCode_bad_ind == 0:
                                                      ...
                                                      if (Mandatory.objects.filter(attributes='transmission_TransmissionTypeCode').exists()):
                                                          ...
                                                          if (var == "Yes" and TransmissionTypeCode ==""):
                                                               array1=[]
                                                               bad_ind = 1
                                                               TransmissionTypeCode_bad_ind = 1
                                                      ...
                                                      if (Numcheck.objects.filter(attributes='transmission_TransmissionTypeCode').exists()):
                                                         ...
                                                         if (var == "Yes" and not TransmissionTypeCode.isdigit()):
                                                              array1=[]
                                                              bad_ind = 1
                                                              TransmissionTypeCode_bad_ind = 1
                                                      ...
                                                      if TransmissionTypeCode_bad_ind == 0:
                                                      ...
                                                      if (Mandatory.objects.filter(attributes='transmission_SystemVersionIdentifier').exists()):
                                                          ...
                                                          if (var == "Yes" and SystemVersionIdentifier ==""):
                                                               array1=[]
                                                               bad_ind = 1
                                                               SystemVersionIdentifier_bad_ind = 1
                                                               description = "SystemVersionIdentifier is mandatory"
                                                               array1.append(serial)
                                                               array1.append(transmissionid)
                                                               array1.append(SenderName)
                                                               array1.append(SystemVersionIdentifier)
                                                               array1.append(description)
                                                               array_bad.append(array1)
                                                      ...
                                                      if (Numcheck.objects.filter(attributes='transmission_SystemVersionIdentifier').exists()):
                                                         ...
                                                         if (var == "Yes" and not SystemVersionIdentifier.isdigit()):
                                                              array1=[]
                                                              bad_ind = 1
                                                              SystemVersionIdentifier_bad_ind = 1
                                                      ...
                                                      if SystemVersionIdentifier_bad_ind == 0:
